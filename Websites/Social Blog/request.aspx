<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage_after.master" AutoEventWireup="true" CodeFile="request.aspx.cs" Inherits="registration" %>
                        ...
                        <blockquote>
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <br />
                                    <asp:LinkButton ID="lnk_accept" CssClass="btn btn-success" runat="server" Text="Accept" CommandName="onAccept" CommandArgument='<%#Bind("friend_reg_id") %>'><span class="glyphicon glyphicon-ok"></span> Accept</asp:LinkButton>
                                    <asp:LinkButton ID="lnk_reject" CssClass="btn btn-danger" runat="server" Text="Reject" CommandName="onReject" CommandArgument='<%#Bind("friend_reg_id") %>'><span class="glyphicon glyphicon-remove"></span> Reject</asp:LinkButton>
                                </div>
                            </div>
                        </blockquote>
                    </div>
